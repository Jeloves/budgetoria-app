...
import { AccountTransactions, AccountTransactionsPropsType } from "./account-transactions";
...
} as Meta<typeof AccountTransactions>;

const Template: StoryFn<AccountTransactionsPropsType> = (args) => <AccountTransactions {...args} />;
