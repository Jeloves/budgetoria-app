...
import styles from "./account-transactions.module.scss";
import { useEffect, useState } from "react";
import classNames from "classnames";

export type AccountTransactionsPropsType = {
...
export function AccountTransactions(props: AccountTransactionsPropsType) {
	const { account, subcategories, clearedTransactions, unclearedTransactions } = props;
	...
	console.log(dateTransactionsMap);
	...
	return (
		<section className={styles.accountTransactions}>
			<header className={styles.header}>
				<div className={styles.headerContent}>
					<button>
						{/* eslint-disable-next-line @next/next/no-img-element */}
						<img src="/icons/arrow-left.svg" alt="Button to return to Accounts Page." />
						Accounts
					</button>
			...
			<main className={styles.content}>{transactionItems}</main>
		</section>
	);
}
